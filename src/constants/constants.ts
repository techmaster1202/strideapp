...
export const LABEL_SendPasswordResetLink = 'Send Password Reset Link';
...
export const LABEL_DeleteAccount = 'Delete Account';
export const LABEL_DeleteRecord = 'Delete Record';
